...
export declare class SubjectsService {
    ...
    assignTeacher(subjectId: string, teacherId: string): Promise<{
        subject: {
            class: {
                name: string;
                id: string;
    ...
    unassignTeacher(subjectId: string, teacherId: string): Promise<{
        message: string;
    }>;
    getSubjectStats(id: string): Promise<{
    ...
    findByTeacher(teacherId: string, page?: number, limit?: number): Promise<{
        subjects: ({
            class: {
                name: string;
                id: string;
