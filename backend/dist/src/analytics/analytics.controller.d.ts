...
export declare class AnalyticsController {
    ...
    getMyPerformance(req: any, subjectId?: string): Promise<{
        assignments: {
            total: number;
            submitted: number;
            graded: number;
    ...
    getAttendanceAnalytics(subjectId?: string, startDate?: string, endDate?: string): Promise<{
    ...
    getTeacherAnalytics(req: any): Promise<{
        subjectId: string;
        subjectName: string;
        totalStudents: number;
        totalAssignments: number;
    ...
    getTeacherAnalyticsById(teacherId: string): Promise<{
        subjectId: string;
        subjectName: string;
        totalStudents: number;
        totalAssignments: number;
