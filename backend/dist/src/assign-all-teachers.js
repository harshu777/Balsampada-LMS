...
async function assignAllTeachers() {
    ...
    try {
        ...
        const uniqueSubjects = subjects.filter((subject, index, self) => index === self.findIndex(s => s.name === subject.name && s.classId === subject.classId));
...
assignAllTeachers();
//# sourceMappingURL=assign-all-teachers.js.map